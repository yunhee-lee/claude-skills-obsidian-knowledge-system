...
/contents-recommender [키워드 또는 문장]
    │
    ▼
문서 생성 — (Recommendation) 키워드.md in {{VAULT_PATH}}/0️⃣ Inbox/
    │
    ▼
...
- 키워드 + 연관어로 검색
- 관련 노트 발견 시 → 노트 직접 추천 (링크 + 내용 한 줄 설명)
